...
public class ServerApp {
  ...
  void service(int port) {
    ...
    try (ServerSocket serverSocket = new ServerSocket(port);
      ...
      TeacherDao teahcerDao = new TeacherDao(new ArrayList<Teacher>());
      teahcerDao.load("teacher.json");
      ...
      TeacherServlet teacherServlet = new TeacherServlet(teahcerDao);
