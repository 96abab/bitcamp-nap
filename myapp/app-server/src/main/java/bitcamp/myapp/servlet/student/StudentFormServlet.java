...
public class StudentFormServlet extends HttpServlet { 
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    out.println("  <td><input type='text' name='working'>미취업.0 재직중.1</td>");
    //    out.println("  <td><input type='radio' name='working' value='1' checked>재직중");
    //    out.println("  <input type='radio' name='working' value='0' checked>미취업</td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>성별</th>");
    out.println("  <td><input type='text' name='gender'>남자.0 여자.1</td>");
    //    out.println("  <td><input type='radio' name='gender' value='0' checked>남자");
    //    out.println("  <input type='radio' name='gender' value='1' checked>여자</td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>전공</th>");
    out.println("  <td><input type='text' name='level'>비전공자.0 준전공자.1 전공자.2</td>");
    //    out.println("  <td><input type='radio' name='level' value='0' checked>비전공자");
    //    out.println("  <input type='radio' name='level' value='1' checked>준전공자");
    //    out.println("  <input type='radio' name='level' value='2' checked>전공자</td>");
    out.println("</tr>");
    out.println("</table>");
    out.println("<div>");
