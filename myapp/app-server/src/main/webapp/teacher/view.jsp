...
<script>
document.querySelector('#btn-list.jsp').onclick = function() {
  location.href = 'list.jsp';
}
document.querySelector('#btn-delete.jsp').onclick = function() {
  var form = document.querySelector('#teacher-form.jsp');
