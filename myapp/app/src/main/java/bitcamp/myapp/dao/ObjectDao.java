...
public abstract class ObjectDao {
  ...
  public void update(Object value) {
    ...
    // 커서가 가리키는 노드의 값을ㅍ파라미터로 받은 값으로 바꾼다
    cursor.value = value;
  ...
  public Object get(int index) {
    ...
    // 현재 커서가 가리키는 노드에서 value 필드의 값을 꺼내 리턴
    return cursor.value;
  }
}
